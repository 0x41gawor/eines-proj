...
# zauważ ze ten skrypt uruchamia się tak: `sudo python ./pox.py routing_controller &`

def launch ():
  global start_time # To jest taki keyword, któy pozwala mofygikować global zmiennych w local scope funkcji
